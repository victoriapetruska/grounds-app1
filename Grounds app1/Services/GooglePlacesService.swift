...
nonisolated struct PlaceDetails: Decodable {
...
nonisolated struct WeekdayHours: Decodable {
...
actor GooglePlacesService {
    ...
    // MARK: - Place Details (hours, phone, website)
    func fetchDetails(placeID: String) async throws -> PlaceDetails? {
        let fields = "formatted_phone_number,website,opening_hours"
